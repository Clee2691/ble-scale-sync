...
A cross-platform CLI tool that reads body composition data from **24+ BLE smart scales** and exports to **Garmin Connect**, **Strava**, **MQTT** (Home Assistant), **InfluxDB**, **Webhooks**, **Ntfy**, **Telegram**, and **local files** (CSV/JSONL). No phone app needed. Your data stays on your device.
